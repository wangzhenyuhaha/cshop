        ...
        model.applyShopInfo.value?.also {
            ...
            return if (it.thrcertflag == 1) {
                !(it.regMoney == null || it.employeeNum == null || it.operateLimit == null || it.inspect == null || it.thrcertflag == null
                        || it.organCode.isNullOrEmpty() || it.organexpire == null
                        || it.companyLinkName.isNullOrEmpty() || it.companyLinkPhone.isNullOrEmpty())
            } else {
                !(it.regMoney == null || it.employeeNum == null || it.operateLimit == null || it.inspect == null
                        || it.thrcertflag == null || it.companyLinkName.isNullOrEmpty() || it.companyLinkPhone.isNullOrEmpty())
            }
...
//model.go.value = 1
    ...
    private fun initObserver() {
        ...
        model.applyShopInfo.observe(this, Observer { info ->
            ...
            //店铺经营类目
            binding.goodsManagementCategoryTextView.text = info.categoryNames?.replace(" ", "/")
            //店铺地址
